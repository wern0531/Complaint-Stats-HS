<template>
  <div class="bg-white rounded-lg shadow-md p-6">
    <h3 class="text-lg font-medium text-gray-900 mb-4">搜尋篩選</h3>
    ...
    <form @submit.prevent="handleSearch" class="space-y-4">
      ...
      <!-- 產品篩選 -->
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">產品品項</label>
        <input 
      ...
      <!-- 機台篩選 -->
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">製造機台</label>
        <select 
      ...
      <!-- 通路篩選 -->
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">購買通路</label>
        <select 
      ...
      <!-- 狀態篩選 -->
      <div>
        <label class="block text-sm font-medium text-gray-700 mb-2">距離有效期限</label>
        <select 
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-2">排序欄位</label>
          <select 
